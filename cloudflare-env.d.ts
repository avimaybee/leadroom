// Auto-generated — do not edit manually. Sync with wrangler.jsonc.
/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: fde4b7ae9b03d085211cc099ced4c948)
// Runtime types generated with workerd@1.20260616.1 2024-09-23 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	BROWSER: BrowserRun;
	ASSETS: Fetcher;
	WORKER_SELF_REFERENCE: Service<typeof import("./src/entry").default>;
	RESEARCH_SNAPSHOT_WORKFLOW: Workflow<Parameters<import("./src/entry").ResearchSnapshotWorkflow['run']>[0]['payload']>;
	DISCOVERY_SEARCH_WORKFLOW: Workflow<Parameters<import("./src/entry").DiscoverySearchWorkflow['run']>[0]['payload']>;
	MONITOR_STALLED_LEAD_WORKFLOW: Workflow<Parameters<import("./src/entry").MonitorStalledLeadWorkflow['run']>[0]['payload']>;
}
